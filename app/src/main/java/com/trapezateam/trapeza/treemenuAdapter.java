...
//import com.trapezateam.trapeza.models.menuTree;
//
///**
...
//
//    menuTree.Vertex mRoot;
//    menuTree.Vertex mCurrentVertex;
//
//    Bill mBill;
//
//    public static final int ID_UP = -1;
//
//    public treemenuAdapter(menuTree graph, Bill bill) {
//        mRoot = graph.getRoot();
...
//        if (i == 0) {
//            button.setText(new Dish("Back", "<-", 0));
...
//        }
//        button.setEnabled(true);
//        final menuTree.Vertex v = mCurrentVertex.getChildren().get(i - 1);
...
//    }
//
//    void changeVertexTo(menuTree.Vertex v) {
//        mCurrentVertex = v;
